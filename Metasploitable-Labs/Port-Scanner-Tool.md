...
This project involved the development of a custom, multi-threaded $\text{TCP}$ port scanner written in Python 3. The objective was to demonstrate foundational skills in network socket programming, concurrency management, and scripting complex reconnaissance tasks.
...
**Key Technologies:** Python 3, $\text{socket}$ module, $\text{threading}$ module, $\text{Queue}$ module.
